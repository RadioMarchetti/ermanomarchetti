      ...
      <Header />
        <div className="content" >
          <section className="help-card">
            <a rel="noopener noreferrer" target="_blank" href="https://play.google.com/store/apps/details?id=com.google.android.apps.classroom&hl=pt_BR"><p className="margintop75rem hover align-center">Clique aqui para baixar o aplicativo para Android</p></a>
