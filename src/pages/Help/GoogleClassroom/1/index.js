    ...
    <div className="help-classroom-container vertical-align">
      <Header />
        <div className="content" >
          ...
          <p>&emsp;Olá, aqui você aprenderá a entrar e adicionar códigos no Google Classroom, para isso, vamos precisar do seu RA, se você já tiver seu RA, clique em <b>Próximo</b>.</p>
