    ...
    <div className="help-classroom-container vertical-align">
      <Header />
        <div className="content" >
          ...
          <p>&emsp;Agora que você já tem seu RA, gerar o e-mail é facil, preencha seu RA abaixo para gerar seu e-mail e depois continue seguindo as instruções. O dígito é o que vem apoś o RA (ex.: 103445867-<b>1</b>).</p>
          <div  id="geraremail">
            <p className="title">
              Gerar seu e-mail
            </p>
